...
user1.make_deposit(50).make_withdrawal(20).display_user_balance()  
...
user2.make_deposit(60).make_withdrawal(30).display_user_balance().transfer_money(user1,100)
...
user3.make_deposit(70).make_withdrawal(30).display_user_balance().transfer_money(user1,100)
